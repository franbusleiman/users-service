package com.busleiman.usersservice.configuration;
...
public class BCryptConfig {
    ...
    public String AUTH_SERVER = "http://localhost:1238/api/security";
    ...
    @Bean
        public Docket api() {
            ...
            return new Docket(DocumentationType.SWAGGER_2)
                    .select()
                    .apis(RequestHandlerSelectors.basePackage("com.busleiman.usersservice"))
    ...
    private List<SecurityReference> defaultAuth() {
        ...
        private ApiInfo apiInfo() {
            return new ApiInfoBuilder().title("Users API").description("")
